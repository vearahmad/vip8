...
Yb    dP 888888    db    88""Yb      Yb    dP 88 88""Yb .dP"o. 
 Yb  dP  88__     dPYb   88__dP       Yb  dP  88 88__dP `8b.d' 
  YbdP   88""    dP__Yb  88"Yb   .o.   YbdP   88 88"""  d'`Y8b 
   YP    888888 dP""""Yb 88  Yb ,dP'    YP    88 88     `bodP'
\033[1;91m
\033[1;97m
\033[1;97m
\033[1;92m
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m1- ᴄʀᴀᴄᴋ ғɪʟᴇ✓')
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;93mɴᴀᴍᴇ ғɪʟᴇ : ')
...
def Settings():
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mMOBILE\x1b[1;95m [ʀx47ᴄ]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (vear,vip8-ᴛᴇsᴛ) {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
